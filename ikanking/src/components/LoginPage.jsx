                ...
                <div className="bg-white shadow-2xl rounded-lg p-8 max-w-md w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-center">
                            <button
                                type="submit"
                                className="bg-dark-blue text-white hover:bg-white hover:text-dark-blue border-solid border-2 border-dark-blue font-bold py-4 px-4 rounded-full focus:outline-none focus:shadow-outline w-full transition duration-300 ease-in-out transform"
                            >
                                Sign in
                            </button>
                        </div>
